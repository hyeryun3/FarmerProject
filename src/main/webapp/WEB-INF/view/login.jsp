			...
			<div class="join_form">
				<fieldset>
					...
					<form class="loginform" method="post" action="./afterlogin.do" >
						...
						아이디 <input type="text" name="id" id="id"> <span title="id"></span><br>
						비밀번호 <input type="password" name="pw" id="pw"> <span
							title="pw"></span><br>
						<button id="logbtn">로그인</button>
						<div class="lostinfo" style="text-align:center; margin-bottom:1em; color:#949494">
							<a class="findpw">비밀번호 찾기</a> | <a class="findid">아이디 찾기</a><br /> <a
								href="./join.do">회원가입</a>
						</div>
					</form>
					<div class="socialbtn">
						<a href="./index_after.html" class="naverbtn"><img
							src="./resources/images/naver.png" alt="네이버 로그인" /></a> <a
							href="./index_after.html" class="kakaobtn"><img
			...
			<div class="join_form">
				<fieldset>
					...
					<form class="pwform" action="./findpw.do" method="POST">
						아이디 <input type="text" name="pid" id="pid"> <span title="pid"></span><br>
						이메일 <input type="text" name="pemail" id="pemail"> <span title="pemail"></span><br>
						<button id="findpwbtn">비밀번호 찾기</button>
						<div class="lostinfo" style="text-align:center; margin-top:1em; color:#949494">
		...
		<div class="idmain">
			...
			<div class="join_form">
				<fieldset>
					...
					<form class="idform">
						이름 <input type="text" name="name" id="iname"> <span title="name"></span><br>
						이메일 <input type="text" name="email" id="iemail"> <span title="email"></span><br>
